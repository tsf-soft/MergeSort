...
В качестве второй и третьей группы параметров, - как указано в разделе 4.2 - используются имена файлов файловой системы Windows. К именам этих аргументов применимы стандартные требования Windows, а именно имена могут задаваться:
...
- простым имем файла (без указания пути) `MyFile.txt`;
