...
>либо её `exe`-версию. Об элементах командной строки, указанных в CLI-листингах, сказано далее, в разделе [Агрументы командной строки утилит](#3.2.-агрументы-командной-строкиутилит).
...
В разделе [3.2. Агрументы командной строки утилит](#3.2.-агрументы-командной-строки-утилит) перечислены три категории опций, указываемых в командной строке.
