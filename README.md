...
>Примечание: направление символов слэш (прямой или обратный) - для утилиты не имеет значения. В одном пути к файлу могут быть указаны и те и другие символы, например: `C:/Users\TSFUser\eclipse-workspace/MergeSort/data/temp_data\MyFile.txt` - утилита перекодирует такие символы, поэтому возможно исопльзование любых вариантов.
