...
- Утилита ___подготовки___ файлов входных данных для сортировки (в двух вариантах запуска):
  ...
  |:-----|--------|------------|------------|
  | [`TsfDataPrepare.jar`](https://disk.yandex.ru/d/YZ18-8OZkcdq_w) | ![Логотип Java](https://github.com/tsf-soft/MergeSort/assets/6228605/11b2fe64-6f89-43b7-ada1-e374f4f7af2c) | 1.11.0[^1]  | CLI-утилита подготовки файлов входных данных, запускается через JVM |
  | [`WinTsfDataPrepare.exe`](https://disk.yandex.ru/d/YZ18-8OZkcdq_w) | ![WinTsfDataPrepare - иконка](https://github.com/tsf-soft/MergeSort/assets/6228605/9b514d8b-4578-4814-8ab6-8e99c89d9d41) | 1.20.0[^2] | CLI-утилита подготовки файлов входных данных, запускается исполняющей системой Windows |
...
- Утилита ___сортировки слиянием___ подготовленных файлов входных данных (в двух вариантах запуска):
  ...
  | **Файл** | **Иконка** | **Java (ver)** | **Назначение** |
  |:-----|--------|------------|------------|
  | [`TsfMergeSort.jar`](https://disk.yandex.ru/d/YZ18-8OZkcdq_w) | ![Логотип Java](https://github.com/tsf-soft/MergeSort/assets/6228605/11b2fe64-6f89-43b7-ada1-e374f4f7af2c) | 1.11.0[^1]  | CLI-утилита сортировки слиянием входных данных, запускается через JVM |
  | [`WinTsfMergeSort.exe`](https://disk.yandex.ru/d/YZ18-8OZkcdq_w) | ![WinTsfMergeSort - иконка](https://github.com/tsf-soft/MergeSort/assets/6228605/f9fa10d6-4a6a-4034-8f27-aa45d37ccdd9) | 1.20.0[^2] | CLI-утилита сортировки слиянием входных данных, запускается исполняющей системой Windows |
...
6. Руководство пользователя в виде этого документа, которое также можно посмотреть [здесь на GitHub](https://github.com/tsf-soft/MergeSort).
