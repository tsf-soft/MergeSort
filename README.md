...
В утилитах реализован принцип хранения рабочей конфигурации во внешних файлах. Пользователь может редактировать эти внешние конфигурационные файлы, настраивать их параметры под свои потребности. 

Изменяя конфигурационный файл утилит, их параметры установленные по умолчанию, пользователь таким образом, изменяет режим работы утилит установленный в исходной конфигурации.
...
Для тех терминалов, которые поддерживают режим совместимости с ANSI-терминалами, - возможен "раскрашенный" вывод статистической информации, а также логов о работе программы. Пример такого использовария утилит, показан на рис. 2.4.
...
>Примечание: Терминалы используемых в Windows интерпретаторов командной строки ANSI-решим не поддерживают, поэтому весь вывод утилит в эти терминаты будет монохромным.
