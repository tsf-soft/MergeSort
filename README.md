...
>Примечание: Терминалы интерпретаторов командной строки используемых в Windows ANSI-решим не поддерживают, поэтому весь вывод утилит в эти терминаты будет монохромным.
